...
int main(){
    ...
    for(unsigned i=0;i<12000;++i){
        ...
        // Synchronous dispatch intentionally isolates the virtualized game callback
        // from unrelated real cursor WM_MOUSEMOVE traffic generated by the hosted CI
        // desktop. GetMessagePos is validated inside RoutedMessageScope below.

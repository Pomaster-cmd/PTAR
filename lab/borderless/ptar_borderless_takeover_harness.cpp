...
static LRESULT CALLBACK GameProc(HWND h,UINT m,WPARAM w,LPARAM l){switch(m){case WM_SIZE:++g_gameSizeMsgs;break;case WM_PTAR_LOGICAL_MOUSE:g_lastLogicalX=GET_X_LPARAM(l);g_lastLogicalY=GET_Y_LPARAM(l);return 0;}return DefWindowProcW(h,m,w,l);}

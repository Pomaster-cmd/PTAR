...
private:
    static constexpr size_t kVtableSlots=29; // IDXGISwapChain1 on Win8/8.1.
    ...
    FnGetDesc origGetDesc_=nullptr;
    FnResizeBuffers origResizeBuffers_=nullptr;
    ...
    volatile LONG64 resizeCalls_=0,resizeRemapped_=0,resizeSucceeded_=0;
};

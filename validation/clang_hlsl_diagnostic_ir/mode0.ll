...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define noundef <4 x float> @"?PTAREdgeV04Phase13@@YAT?$__vector@M$03@__clang@@T12@M0000MMMMM@Z"(<4 x float> noundef returned %0, float noundef %1, <4 x float> noundef %2, <4 x float> noundef %3, <4 x float> noundef %4, <4 x float> noundef %5, float noundef %6, float noundef %7, float noundef %8, float noundef %9, float noundef %10) local_unnamed_addr #0 {
  ret <4 x float> %0
}

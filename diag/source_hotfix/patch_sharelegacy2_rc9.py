...
def patch(base,obj,outp):
 ...
 reqs=('shared_transport_legacy_gate','shared_primary_call_wrapper','shared_desc_misc_helper','shared_mutex_qi_helper',
       'mailbox_call_wrapper','mailbox_desc_misc_helper','mailbox_producer_mutex_qi_helper','mailbox_display_mutex_qi_helper')
 for req in reqs:
 ...
 print('SHARELEGACY2_CODE_SIZE=0x%X'%len(code))

#!/usr/bin/env python3
"""Deterministic RC18 PRESENTDELIVERY1 -> DWMPHASE1 diagnostic lab patch.
...
def main():
    if len(sys.argv)!=4: raise SystemExit('usage: patch_dwmphase1_rc18.py RC18_DLL DWMPHASE_OBJ OUT_DLL')

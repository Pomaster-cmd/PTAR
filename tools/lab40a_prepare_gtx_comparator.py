...
OUTDIR = ROOT / "lab_results" / "lab40a_gtx_pack"
OUT = OUTDIR / "ptar_lab40a_compare.cpp"
...
LAB40A_SHA = "9b6fa72a22216e7aafa0e24f33d0b83fc21bf0c2c346c96767c3dedce6ba1293"
...
def main() -> None:
    ...
    text = replace_exact(text, OLD_LAB29_SHA, LAB40A_SHA)
    for old, new in (
        ("Lab28", "Lab38A"), ("Lab29", "Lab40A"),
        ("LAB28", "LAB38A"), ("LAB29", "LAB40A"),
        ("lab28", "lab38a"), ("lab29", "lab40a"),
    ):
    ...
    required = [
        LAB38A_SHA, LAB40A_SHA, "LAB38A", "LAB40A", "lab38a.cso", "lab40a.cso",
        "LAB40A_COMPARE_RAW.csv", "LAB40A_COMPARE_SUMMARY.json", "if(variant==2)",

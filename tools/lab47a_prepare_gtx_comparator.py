...
OUTDIR = ROOT / "lab_results" / "lab47a_gtx_pack"
OUT = OUTDIR / "ptar_lab47a_compare.cpp"
...
def main() -> None:
    ...
    text = replace_exact(text, OLD_LAB29_SHA, LAB47A_SHA)
    for old, new in (
        ("Lab28", "Lab38A"), ("Lab29", "Lab47A"),
        ("LAB28", "LAB38A"), ("LAB29", "LAB47A"),
        ("lab28", "lab38a"), ("lab29", "lab47a"),
    ):
    ...
    required = [
        LAB38A_SHA, LAB47A_SHA,
        "LAB38A", "LAB47A", "lab38a.cso", "lab47a.cso",
        "LAB47A_COMPARE_RAW.csv", "LAB47A_COMPARE_SUMMARY.json",
        "if(variant==2)",

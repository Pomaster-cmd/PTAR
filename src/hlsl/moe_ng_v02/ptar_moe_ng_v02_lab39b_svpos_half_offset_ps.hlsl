// PTAR-NG MoE v02 - LAB39B SV_Position half-offset exact x1.5 mapping candidate
// Baseline: LAB38A. Exact x1.5 only. ABI and reconstruction unchanged.
// D3D11 rasterized SV_Position.xy is integer pixel + 0.5 at pixel centers;
// subtracting 0.5 therefore replaces floor(SV_Position.xy) exactly for this pass.
// Intended codegen change: first ROUND_NI -> ADD, with bit-exact output required.

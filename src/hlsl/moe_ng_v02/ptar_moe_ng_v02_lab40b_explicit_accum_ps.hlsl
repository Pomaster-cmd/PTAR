// PTAR-NG MoE v02 - LAB40B exact scheduling/codegen candidate
// Baseline: replicated hardware-selected LAB38A. Exact x1.5 only. ABI unchanged.
// Keeps LAB38A dataflow but spells the cubic accumulation explicitly to probe FXC scheduling/register allocation.

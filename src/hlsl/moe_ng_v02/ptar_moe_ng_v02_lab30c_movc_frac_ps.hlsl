// PTAR-NG MoE v02 - LAB30C combined direct slope gate + fractional phase
// Baseline: hardware-selected LAB29. Exact x1.5 only.
// Combines LAB30A's direct conditional slope gate with LAB30B's removal of
// integer modulo/udiv from the phase path.

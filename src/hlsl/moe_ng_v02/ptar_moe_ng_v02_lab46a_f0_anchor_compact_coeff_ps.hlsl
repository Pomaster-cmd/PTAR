// PTAR-NG MoE v02 - LAB46A f0-anchor compact coefficient evaluation
// Baseline: hardware-selected LAB38A. Exact x1.5 only. ABI unchanged.
// Uses coeff.x+coeff.z=27 to anchor the cubic at f0 and eliminate one weighted basis term.
...
float4 main(PSIn input):SV_Target{
 ...
 float3 coeff=mad(phaseHigh,float3(13.0f,-1.0f,-1.0f),float3(7.0f,2.0f,-1.0f));
 float4 residual=coeff.x*d1+coeff.y*m0x2+coeff.z*m1x2;
 float4 cubic=mad(residual,(1.0f/27.0f),f0);

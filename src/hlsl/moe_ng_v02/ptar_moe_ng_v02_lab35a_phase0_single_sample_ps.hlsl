// PTAR-NG MoE v02 - LAB35A Phase-0 Single-Sample Early Exit
// Baseline: hardware-selected LAB31G. Exact x1.5 only. ABI unchanged.
// Goal: phase 0 must execute GatherGreen + only the center SampleLevel.
// fm1/axis/f1/f2 work is deliberately placed after the phase-0 return.

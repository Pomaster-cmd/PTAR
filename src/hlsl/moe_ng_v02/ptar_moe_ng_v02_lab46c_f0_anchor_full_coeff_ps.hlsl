// PTAR-NG MoE v02 - LAB46C f0-anchor full coefficient evaluation
// Baseline: hardware-selected LAB38A. Exact x1.5 only. ABI unchanged.
// Keeps LAB38A's exact float4 coefficient synthesis but uses coeff.x+coeff.z=27 to anchor at f0.
...
float4 main(PSIn input):SV_Target{
 ...
 float4 residual=coeff.z*d1+coeff.y*m0x2+coeff.w*m1x2;

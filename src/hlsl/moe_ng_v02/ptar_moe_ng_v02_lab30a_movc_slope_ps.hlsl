// PTAR-NG MoE v02 - LAB30A direct conditional slope gate
// Baseline: hardware-selected LAB29. Exact x1.5 only.
// Experiment: replace limited*step(0,a*b) with a direct conditional select.
// Intended DXBC effect: remove the boolean 0/1 materialization + multiply path.
...
float4 main(PSIn input) : SV_Target
{
    ...
    float4 coeff=(phaseIndex==1u)?float4(7.0f,1.0f,20.0f,-2.0f):float4(20.0f,2.0f,7.0f,-1.0f);

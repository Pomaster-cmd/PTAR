// PTAR-NG MoE v02 - LAB37A diagonal-product direction + component-wise axis MOVC + linear phase coefficients
// Baseline: hardware-selected LAB36B. Exact x1.5 only. ABI unchanged.
// Combines LAB36B's admitted direction/axis transforms with LAB34B's admitted
// linear coefficient synthesis. Texture issue order and phase-zero branch remain unchanged.
...
float4 main(PSIn input):SV_Target{
 ...
 float4 coeff=mad(phaseFrac,float4(-39.0f,-3.0f,39.0f,-3.0f),float4(33.0f,3.0f,-6.0f,0.0f));

// PTAR-NG MoE v02 - LAB42D packed +/-axis UV with reordered sample declarations
...
float4 main(PSIn input):SV_Target{
 ...
 float4 f1=gSource.SampleLevel(gLinearClamp,uvMP.zw,0.0f);
 float4 f2=gSource.SampleLevel(gLinearClamp,uvP2,0.0f);
 float4 fm1=gSource.SampleLevel(gLinearClamp,uvMP.xy,0.0f);

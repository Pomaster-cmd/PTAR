// PTAR-NG MoE v02 - LAB49B precise SV_Position center subtraction candidate
...
// Uses precise intermediates to prevent FXC from contracting (SV_Position-0.5)*(2/3)
// into the LAB48B-style MAD that failed WARP parity.
...
float4 main(PSIn input):SV_Target{
 precise float2 outPix=input.position.xy-0.5f;
 precise float2 srcPos=outPix*(2.0f/3.0f);

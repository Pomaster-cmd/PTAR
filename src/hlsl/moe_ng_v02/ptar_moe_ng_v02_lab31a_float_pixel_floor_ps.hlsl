// PTAR-NG MoE v02 - LAB31A Float Pixel Floor
// Baseline: hardware-selected LAB30C. Exact x1.5 only.
// Goal: remove uint<->float pixel-coordinate conversions while preserving the
// exact integer pixel index represented by SV_Position on the single-sample
// fullscreen pass. No texture-footprint or reconstruction change intended.

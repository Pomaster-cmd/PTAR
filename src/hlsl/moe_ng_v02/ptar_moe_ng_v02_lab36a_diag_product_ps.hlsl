// PTAR-NG MoE v02 - LAB36A diagonal-product direction test
// Baseline: hardware-selected LAB31G. Exact x1.5 only. ABI unchanged.
// Revisit of LAB33E after LAB35A hardware-neutral result: preserve LAB31G texture
// issue order and branch placement; only replace |gx|>=|gy| with the algebraically
// equivalent diagonal-product direction predicate.

// PTAR-NG MoE v02 - LAB36B diagonal-product direction + component-wise axis MOVC
// Baseline: hardware-selected LAB31G. Exact x1.5 only. ABI unchanged.
// Combines the software-admitted LAB36A direction predicate with LAB32B's
// bit-exact component-wise axis construction while preserving LAB31G texture
// issue order and phase branch placement.

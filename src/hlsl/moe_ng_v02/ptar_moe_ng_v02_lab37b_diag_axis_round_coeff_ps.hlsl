// PTAR-NG MoE v02 - LAB37B exact rounded phase selector coefficient synthesis
// Baseline: hardware-selected LAB36B. Exact x1.5 only. ABI unchanged.
// Replaces the phase > 0.5 vector select with round(phaseFrac) followed by an
// integer-exact coefficient MAD. Texture issue order and phase-zero branch unchanged.

// PTAR-NG MoE v02 - LAB43C split-gap packed positive UV
...
// then place independent phase work around f1/f2 to keep ALU/texture overlap.
...
float4 main(PSIn input):SV_Target{
 ...
 float4 f1=gSource.SampleLevel(gLinearClamp,plusUV.xy,0.0f);
 float4 coeff=mad(phaseHigh,float4(-13.0f,-1.0f,13.0f,-1.0f),float4(20.0f,2.0f,7.0f,-1.0f));
 float4 f2=gSource.SampleLevel(gLinearClamp,plusUV.zw,0.0f);

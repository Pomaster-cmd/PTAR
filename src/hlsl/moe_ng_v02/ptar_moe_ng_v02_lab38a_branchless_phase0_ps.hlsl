// PTAR-NG MoE v02 - LAB38A branchless phase-zero return candidate
// Baseline: hardware-selected and replicated LAB37B. Exact x1.5 only. ABI unchanged.
// Removes divergent phase-zero control flow while preserving exact phase-zero output
// with a final MOVC. Texture declaration/count contract remains 1 Gather + 4 SampleLevel.

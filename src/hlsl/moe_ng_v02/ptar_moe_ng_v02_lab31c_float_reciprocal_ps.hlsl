// PTAR-NG MoE v02 - LAB31C Float Pixel Floor + Reciprocal Hoist
// Baseline: hardware-selected LAB30C. Exact x1.5 only.
// Combines LAB31A and LAB31B: no uint<->float pixel conversion, one reciprocal
// computation for all input-size scaling, direct axisUV materialization.
